        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
                  ...
                  <div className="relative backdrop-blur-sm bg-white/60 border border-white/20 rounded-2xl p-5 shadow-lg hover:shadow-xl transition-all duration-500 overflow-hidden">
                    ...
                    <div className="relative flex items-start space-x-4">
                      ...
                      <div className="flex-shrink-0 relative">
                        <div
                          className={`w-14 h-14 rounded-xl flex items-center justify-center transition-all duration-500 transform group-hover:scale-110 group-hover:rotate-3 ${
                            index === 0
                        ...
                        >
                          <IconComponent
                            className={`w-7 h-7 ${feature.color} transition-all duration-500 group-hover:scale-110`}
                          />
                        </div>
          ...
          >
            <div className="relative max-w-sm w-full">
              ...
              <div
                className={`${phoneCardColor} p-6 rounded-3xl shadow-2xl transform hover:scale-105 transition-all duration-500 relative overflow-hidden`}
              >
                {/* Animated Border */}
                ...
                <div
                  className="absolute -bottom-2 -left-2 w-4 h-4 bg-gradient-to-r from-yellow-300 to-orange-300 rounded-full opacity-80 animate-bounce shadow-lg"
              ...
              <div
                className="absolute -z-10 bottom-4 right-4 w-16 h-16 bg-gradient-to-br from-blue-200/40 to-indigo-200/40 rounded-full blur-sm animate-bounce"
                style={{ animationDelay: "2s" }}
              ></div>
              <div
                className="absolute -z-10 top-1/2 -left-8 w-12 h-12 bg-gradient-to-br from-cyan-200/30 to-teal-200/30 rounded-full blur-sm animate-pulse"
