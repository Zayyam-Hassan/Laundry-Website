...
const LaundryServiceExample = () => {
  const { Truck, Star, Shield, Clock } = require('lucide-react');
...
const TechServiceExample = () => {
  const { Zap, Code, Cpu, Smartphone } = require('lucide-react');
  
  return (
    <FeatureForAll
      title="Advanced Tech Solutions"
      subtitle="Cutting-edge technology services designed to accelerate your business growth with AI-powered solutions and seamless integrations."
      highlightText="24/7 Support Available"
      highlightIcon={Zap}
      showFeatures={true}
      features={[
        {
          ...
          description: "Tailored software solutions built with modern frameworks and best practices"
        },
        {
          icon: Cpu,
          title: "AI Integration",
          description: "Smart automation and machine learning capabilities for your business"
        },
        {
          icon: Smartphone,
          title: "Mobile-First Design",
          description: "Responsive applications optimized for all devices and platforms"
        }
      ]}
      theme={{
        highlightColor: "text-cyan-400",
        highlightBg: "bg-cyan-400/10",
...
const FitnessServiceExample = () => {
  const { Heart, Target, Users, Trophy } = require('lucide-react');
  
  return (
    <FeatureForAll
      title="Transform Your Fitness Journey"
      subtitle="Join thousands of members who have achieved their fitness goals with our personalized training programs and expert guidance."
      highlightText="Personal Trainer Included"
      highlightIcon={Heart}
      showFeatures={true}
      features={[
        {
          ...
          description: "Customized workout plans designed to meet your specific fitness objectives"
        },
        {
          icon: Users,
        ...
        },
        {
          ...
          description: "Monitor your progress with detailed analytics and milestone celebrations"
        }
      ]}
      theme={{
        highlightColor: "text-green-400",
        highlightBg: "bg-green-400/10",
        highlightBorder: "border-green-400/30",
...
const MinimalExample = () => {
  const { Gift } = require('lucide-react');
  
  return (
    <FeatureForAll
      title="Special Offer"
      subtitle="Limited time promotion with exclusive benefits for new customers."
      highlightText="50% Off First Month"
      highlightIcon={Gift}
      showFeatures={false}
    />
  );
...
const CustomThemeExample = () => {
  const { Sparkles, Diamond, Crown, Gem } = require('lucide-react');
  
  return (
    <FeatureForAll
      title="Luxury Experience"
      subtitle="Indulge in our premium services with exclusive benefits and personalized attention to detail."
      highlightText="VIP Treatment Included"
      ...
      features={[
        {
          ...
          description: "Only the finest quality materials and craftsmanship"
        },
        {
          icon: Crown,
          title: "Royal Service",
          description: "White-glove treatment with dedicated personal assistance"
        },
        {
          icon: Gem,
          title: "Exclusive Access",
          description: "Members-only benefits and priority booking privileges"
        }
      ]}
      theme={{
        bgColor: "bg-[linear-gradient(135deg,#1e1b4b_0%,#7c3aed_25%,#a855f7_50%,#7c3aed_75%,#1e1b4b_100%)]",
        highlightColor: "text-purple-300",
        highlightBg: "bg-purple-400/10",
        highlightBorder: "border-purple-400/30",
        featureIconColor: "text-purple-300"
      }}
    />
  );
};
